...
############  OUTPUT  ############
# test 1 matches reference 1 (distance : 0.2937587353219999)
# test 2 matches reference 2 (distance : 0.18605214358)
# test 3 matches reference 1 (distance : 0.5834047750419998)
# test 4 matches reference 2 (distance : 0.13370981554400002)
# test 5 matches reference 2 (distance : 0.11843070533600002)
# test 6 matches reference 1 (distance : 1.752858331625)
############  OUTPUT  ############
...
reference_dir = join('..', 'time_series_dataset', 'level2', 'reference')
references = []
...
test_dir = join('..', 'time_series_dataset', 'level2', 'test')
tests = []
